...
- **[anysearch](./anysearch)**: Official implementation of “One Policy, Any Budget,” including budget-aware curriculum, group rewards, retrieval, and cross-budget evaluation.
...
- **[search-r1](./search-r1)**: A lightweight Search-R1 example featuring multi-turn conversation and tool-calling.
